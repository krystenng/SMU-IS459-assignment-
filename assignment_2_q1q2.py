...
print("Number of edges without duplciate :" + str(id_to_id.count())) #751461
...
# QUESTION 1 TO FIND THE CONNECTED COMPONENTS
...
# QUESTION 1 TO GET THE KEY WORDS FROM THE COMMUNITY
...
# QUESTION 2 TO GET THE NUMBER OF TRIANGLES
